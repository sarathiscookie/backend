...
$offers      = $objOffer->listOffers();
$course_opts = $objOffer->getCourseOptions();
$status_opts = $objOffer->getStatusOptions();
$date_opts   = $objOffer->getTypeDateOptions();
$typ_opts    = $objOffer->getTypes();
$hotel_name  = $objOffer->getHotelName();
$hotel_id    = $_GET["hid"];
?>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header">Angebote <small>(<?=$hotel_name?>)</small>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addOfferFrm" onsubmit="return false">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label>Kopfbereich über der Beschreibung </label>
                            <textarea name="header" id="headerTxt" class="form-control textarea mceEditor" rows="10"></textarea>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Fußbereich unter der Beschreibung </label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label>Beschreibung (meist Golfkurs / Bei Angebot nicht nötig)</label>
                    ...
                    <input type="hidden" name="hotel_id" value="<?=$_GET['hid']?>">
                </form>
            </div>
...
<script type="text/javascript">
    ...
    if($('.btnUpdate').length) {
        $("#ofrContainer").on('click', '.btnUpdate', function (e) {
            ...
            $.post("ajax/offers.ajax.php", params , function (data) {
                if(data.success>0) {
    ...
    $('#addOfrBtn').click( function() {
        ...
        $.post("ajax/offers.ajax.php?mode=C", params , function (data) {
            if(data.success>0) {
                $('#addOfferFrm')[0].reset();
